...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( List<Staff> staffs,  int view,  int danmaku,  int uploadTime,  int onlineUser)?  loaded,required TResult orElse(),}) {final _that = this;
switch (_that) {
case VideoBasicInfoLoading() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( List<Staff> staffs,  int view,  int danmaku,  int uploadTime,  int onlineUser)  loaded,}) {final _that = this;
switch (_that) {
case VideoBasicInfoLoading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( List<Staff> staffs,  int view,  int danmaku,  int uploadTime,  int onlineUser)?  loaded,}) {final _that = this;
switch (_that) {
case VideoBasicInfoLoading() when loading != null:
return loading();case VideoBasicInfoLoaded() when loaded != null:
return loaded(_that.staffs,_that.view,_that.danmaku,_that.uploadTime,_that.onlineUser);case _:
...
@useResult
$Res call({
 List<Staff> staffs, int view, int danmaku, int uploadTime, int onlineUser
});
