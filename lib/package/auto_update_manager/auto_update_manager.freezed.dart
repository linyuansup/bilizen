...
part of 'auto_update_manager.dart';
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Downloading value)?  downloading,TResult Function( _Checking value)?  checking,TResult Function( _Completed value)?  completed,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Downloading() when downloading != null:
return downloading(_that);case _Checking() when checking != null:
return checking(_that);case _Completed() when completed != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Downloading value)  downloading,required TResult Function( _Checking value)  checking,required TResult Function( _Completed value)  completed,}){
final _that = this;
switch (_that) {
case _Downloading():
return downloading(_that);case _Checking():
return checking(_that);case _Completed():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Downloading value)?  downloading,TResult? Function( _Checking value)?  checking,TResult? Function( _Completed value)?  completed,}){
final _that = this;
switch (_that) {
case _Downloading() when downloading != null:
return downloading(_that);case _Checking() when checking != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( double progress)?  downloading,TResult Function()?  checking,TResult Function()?  completed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Downloading() when downloading != null:
return downloading(_that.progress);case _Checking() when checking != null:
return checking();case _Completed() when completed != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( double progress)  downloading,required TResult Function()  checking,required TResult Function()  completed,}) {final _that = this;
switch (_that) {
case _Downloading():
return downloading(_that.progress);case _Checking():
return checking();case _Completed():
return completed();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( double progress)?  downloading,TResult? Function()?  checking,TResult? Function()?  completed,}) {final _that = this;
switch (_that) {
case _Downloading() when downloading != null:
return downloading(_that.progress);case _Checking() when checking != null:
return checking();case _Completed() when completed != null:
...
/// @nodoc
abstract mixin class _$DownloadingCopyWith<$Res> implements $DownloadStateCopyWith<$Res> {
